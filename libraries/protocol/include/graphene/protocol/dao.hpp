...
namespace graphene { namespace protocol {
    ...
    struct dao_dapp_options
    {
        uint16_t dapp_permissions = 0;//DEFAULT_DAO_DAPP_PERMISSION;
        uint16_t flags = 0;
    ...
    struct dao_create_operation : public base_operation
    {
        ...
        string           name;
        string           url;
        dao_dapp_options common_options;
        extensions_type  extensions;  ///< Unused. Reserved for future use.
        account_id_type fee_payer() const { return account_id; }
        void validate() const;
        share_type calculate_fee(fee_parameters_type const&) const;
...
FC_REFLECT( graphene::protocol::dao_dapp_options,
            (dapp_permissions)
            (flags)
...
FC_REFLECT( graphene::protocol::dao_account_create_operation::fee_parameters_type,
            (fee)(price_per_kbyte) )
FC_REFLECT( graphene::protocol::dao_dapp_create_operation::fee_parameters_type,
            (fee)(price_per_kbyte) )
...
FC_REFLECT( graphene::protocol::dao_dapp_create_operation,
            (fee)
            (dao_id)
            (name)
            (url)
...
GRAPHENE_DECLARE_EXTERNAL_SERIALIZATION( graphene::protocol::dao_dapp_options )
...
GRAPHENE_DECLARE_EXTERNAL_SERIALIZATION( graphene::protocol::dao_dapp_create_operation::fee_parameters_type )
...
GRAPHENE_DECLARE_EXTERNAL_SERIALIZATION( graphene::protocol::dao_dapp_create_operation )